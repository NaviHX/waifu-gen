...
class styleGAN():
    ...
    def build_generator(self):
        ...
        out = g_block(out, latent, 4)
        out = g_block(out, latent, 2)
    ...
    def load_model_from_disk(self):
        if os.path.exists('./model/generator.h5') and os.path.exists(
...
if __name__ == '__main__':
    ...
    stylegan.train(epochs=15000, batch_size=batch_size, sample_interval=50)
